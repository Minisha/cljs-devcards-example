...
var args34999 = [];
var len__19529__auto___35003 = arguments.length;
var i__19530__auto___35004 = (0);
while(true){
if((i__19530__auto___35004 < len__19529__auto___35003)){
args34999.push((arguments[i__19530__auto___35004]));

var G__35005 = (i__19530__auto___35004 + (1));
i__19530__auto___35004 = G__35005;
continue;
} else {
}
break;
...
var G__35002 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__35002,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__35002;
}
});
...
var len__19529__auto___35010 = arguments.length;
var i__19530__auto___35011 = (0);
while(true){
if((i__19530__auto___35011 < len__19529__auto___35010)){
args__19536__auto__.push((arguments[i__19530__auto___35011]));

var G__35012 = (i__19530__auto___35011 + (1));
i__19530__auto___35011 = G__35012;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq35007){
var G__35008 = cljs.core.first.call(null,seq35007);
var seq35007__$1 = cljs.core.next.call(null,seq35007);
var G__35009 = cljs.core.first.call(null,seq35007__$1);
var seq35007__$2 = cljs.core.next.call(null,seq35007__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__35008,G__35009,seq35007__$2);
});
...
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__35016,map__35016__$1,file,line,column){
return (function (p1__35013_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__35013_SHARP_));
});})(map__35016,map__35016__$1,file,line,column))
...
var temp__4657__auto___35018 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___35018)){
var message_35019 = temp__4657__auto___35018;
cljs.core.println.call(null,message_35019);
} else {
}
...
var temp__4657__auto___35020 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___35020)){
var message_35021 = temp__4657__auto___35020;
cljs.core.println.call(null,message_35021);
} else {
}
...
var G__35027 = exception.stack;
var G__35027__$1 = (((G__35027 == null))?null:clojure.string.split_lines.call(null,G__35027));
var G__35027__$2 = (((G__35027__$1 == null))?null:cljs.core.get.call(null,G__35027__$1,depth));
if((G__35027__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__35027__$2);
}
} else {
...
var vec__35028 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__35028,(0),null);
var column = cljs.core.nth.call(null,vec__35028,(1),null);
var vec__35029 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__35029,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__35029,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__35029,(2),null);
...
var m__$1 = (function (){var G__35031 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__35031) {
case "fail":
...
var G__35037 = (function (){var G__35036 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__35036);
} else {
return G__35036;
}
})();
...
return cljs.core.vary_meta.call(null,G__35039,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e35042){var e = e35042;
var G__35043 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__35043) {
...
var vec__35046 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__35046,(0),null);
var types = vec__35046;
...
return cljs.core.map.call(null,(function (p__35054){
var vec__35055 = p__35054;
var ns = cljs.core.nth.call(null,vec__35055,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__35055,(1),null);
return ((function (vec__35055,ns,vars__$1){
return (function (){
...
var G__35056 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__35056) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__35056,env,once_fixtures,each_fixtures,vec__35055,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__35056,env,once_fixtures,each_fixtures,vec__35055,ns,vars__$1){
return (function (){
var seq__35057 = cljs.core.seq.call(null,vars__$1);
var chunk__35058 = null;
var count__35059 = (0);
var i__35060 = (0);
while(true){
if((i__35060 < count__35059)){
var v = cljs.core._nth.call(null,chunk__35058,i__35060);
var temp__4657__auto___35062 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___35062)){
var t_35063 = temp__4657__auto___35062;
each_fixture_fn.call(null,((function (seq__35057,chunk__35058,count__35059,i__35060,t_35063,temp__4657__auto___35062,v,each_fixture_fn,G__35056,env,once_fixtures,each_fixtures,vec__35055,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35063)));
});})(seq__35057,chunk__35058,count__35059,i__35060,t_35063,temp__4657__auto___35062,v,each_fixture_fn,G__35056,env,once_fixtures,each_fixtures,vec__35055,ns,vars__$1))
);
} else {
}

var G__35064 = seq__35057;
var G__35065 = chunk__35058;
var G__35066 = count__35059;
var G__35067 = (i__35060 + (1));
seq__35057 = G__35064;
chunk__35058 = G__35065;
count__35059 = G__35066;
i__35060 = G__35067;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__35057);
if(temp__4657__auto__){
var seq__35057__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__35057__$1)){
var c__19270__auto__ = cljs.core.chunk_first.call(null,seq__35057__$1);
var G__35068 = cljs.core.chunk_rest.call(null,seq__35057__$1);
var G__35069 = c__19270__auto__;
var G__35070 = cljs.core.count.call(null,c__19270__auto__);
var G__35071 = (0);
seq__35057 = G__35068;
chunk__35058 = G__35069;
count__35059 = G__35070;
i__35060 = G__35071;
continue;
} else {
var v = cljs.core.first.call(null,seq__35057__$1);
var temp__4657__auto___35072__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___35072__$1)){
var t_35073 = temp__4657__auto___35072__$1;
each_fixture_fn.call(null,((function (seq__35057,chunk__35058,count__35059,i__35060,t_35073,temp__4657__auto___35072__$1,v,seq__35057__$1,temp__4657__auto__,each_fixture_fn,G__35056,env,once_fixtures,each_fixtures,vec__35055,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35073)));
});})(seq__35057,chunk__35058,count__35059,i__35060,t_35073,temp__4657__auto___35072__$1,v,seq__35057__$1,temp__4657__auto__,each_fixture_fn,G__35056,env,once_fixtures,each_fixtures,vec__35055,ns,vars__$1))
);
} else {
}

var G__35074 = cljs.core.next.call(null,seq__35057__$1);
var G__35075 = null;
var G__35076 = (0);
var G__35077 = (0);
seq__35057 = G__35074;
chunk__35058 = G__35075;
count__35059 = G__35076;
i__35060 = G__35077;
continue;
}
} else {
...
});})(each_fixture_fn,G__35056,env,once_fixtures,each_fixtures,vec__35055,ns,vars__$1))
);
});})(each_fixture_fn,G__35056,env,once_fixtures,each_fixtures,vec__35055,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1467040426819