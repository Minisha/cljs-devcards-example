...
var len__19529__auto___34216 = arguments.length;
var i__19530__auto___34217 = (0);
while(true){
if((i__19530__auto___34217 < len__19529__auto___34216)){
args__19536__auto__.push((arguments[i__19530__auto___34217]));

var G__34218 = (i__19530__auto___34217 + (1));
i__19530__auto___34217 = G__34218;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq34215){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34215));
});
/**
...
var vec__34220 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__34220,(0),null);
var words = cljs.core.nthnext.call(null,vec__34220,(1));
...
var G__34222 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__34222,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__34222;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__34223_SHARP_){
if(typeof p1__34223_SHARP_ === 'string'){
return p1__34223_SHARP_;
} else {
return cljs.core.seq.call(null,p1__34223_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1467040425849